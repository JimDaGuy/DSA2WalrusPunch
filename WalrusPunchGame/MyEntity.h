...
class MyEntity
{
	...
	int m_row = -1; // row this entity is in. only will colide with others in this row. -1 row will collide with everything
...
public:
	...
	*/
	MyEntity(String a_sFileName, String a_sUniqueID = "NA", int a_row = -1);
	/*
